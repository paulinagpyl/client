...
const Navigation = () => {
      ...
      return (
        <Container>
          <Nav className="navbar">
            <div>
              <NavLink to="/catalogo" className={validateRoot}>Catalogo
              </NavLink>
            </div>
            <div>
              <NavLink to="/registrarse" className={validateRoot}> Registrarse</NavLink>
              <NavLink to="/login" className= {validateRoot}>Iniciar Sesión</NavLink>
            </div>
          </Nav>
        </Container>
      );
  ...
  return (
    <nav className="navbar">
      <span className="logo">🪴Venta Plantas</span>
